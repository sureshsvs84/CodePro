...
import ContractAnchorRenderer from '../../viewComponents/contracts/contractAnchor';
import CompanyAnchor from '../../viewComponents/company/comapnyAnchor';
import HyperLink from '../hyperLink';
import FileToBeOpen from '../../applicationComponents/customer/documents/fileToBeOpen';
import CompnayFileToBeOpen from '../../applicationComponents/company/documents/fileToBeOpen';
...
class ReactGrid extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            frameworkComponents: {
                ...
                CompnayFileToBeOpen: CompnayFileToBeOpen,
            },
    ...
    renderPagination = () => {
        ...
        if (gridLength > this.state.paginationPageSize) {
            return (<div>
                <div className={this.props.gridColData.pagination ? 'input-field col pagedropdownCount ' : 'hide'}>
                ...
                <div className={this.props.gridColData.pagination ? "input-field col pr-0 mr-0 pagination" : "hide"}>
                    ...
                    <input id="currentPage" type="text" className="browser-default customInputs center-align mr-1 pagerInput validate" onBlur={this.currentPageChanged} onKeyPress={this.checkEnterKey} />
                    of<span id="lbTotalPages" className='ml-2'></span>
    ...
    renderExport = () => {
        const gridLength = this.props.gridRowData ? this.props.gridRowData.length : 0;
        if (gridLength > 0) {
            return (<div className={this.props.gridColData.gridActions ? 'input-field col right-left gridExport' : 'hide'}>
...
function setTotalPage(text) {
    ...
    const element = document.querySelector('#lbTotalPages');
