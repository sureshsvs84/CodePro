...
class Notes extends Component {
    ...
    componentDidMount() {
        ...
        // this.props.actions.FetchNotesDetails();        
    }
    ...
    notesSubmitHandler = (e) => {
        ...
        //     this.props.actions.UpdateNotesDetails(this.updatedData);
        //     this.updatedData = {};
        //     this.clearData();
    ...
    //     this.props.actions.DeleteNotesDetails(selectedRecords);        
    ...
    render() {
        const { showButton, 
            //  editRecord,
             notesData } = this.props;
        let customerNoteData = [];
        if (notesData) {
            customerNoteData = notesData.filter(note => note.recordStatus !== "D");
        }
        const modelData = { ...this.confirmationModalData,isOpen:this.state.isOpen };
        // this.props.editRecord.note && (document.getElementById("Note").value = editRecord.note);
        return (
            <Fragment>
                ...
                <div className="customCard">
                            ...
                            <div className="modal-content">
                                <div className="row">
                                    <div className="col s12">
                                        ...
                                        <textarea rows="5" id="Note" maxLength="4000" name="note" onChange={this.handlerChange} className="browser-default" required />
                                    </div>
                                </div>
                    ...
                    <p className="pl-3 pr-3"><b>Customer Notes</b></p>
                    <div className="customCard">
                        <ReactGrid gridRowData={customerNoteData} gridColData={HeaderData.CustomerNoteHeader} onRef={ref => { this.child = ref; }}/>
                    </div>
